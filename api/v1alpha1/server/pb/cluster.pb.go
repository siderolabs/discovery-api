...
const file_v1alpha1_server_pb_cluster_proto_rawDesc = "" +
	"\n" +
	" v1alpha1/server/pb/cluster.proto\x12\x17sidero.discovery.server\x1a\x1cvendor/google/duration.proto\"M\n" +
	"\tAffiliate\x12\x0e\n" +
...
var (
	...
	file_v1alpha1_server_pb_cluster_proto_rawDescData []byte
)

func file_v1alpha1_server_pb_cluster_proto_rawDescGZIP() []byte {
	file_v1alpha1_server_pb_cluster_proto_rawDescOnce.Do(func() {
		file_v1alpha1_server_pb_cluster_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_v1alpha1_server_pb_cluster_proto_rawDesc), len(file_v1alpha1_server_pb_cluster_proto_rawDesc)))
	})
...
func file_v1alpha1_server_pb_cluster_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_v1alpha1_server_pb_cluster_proto_rawDesc), len(file_v1alpha1_server_pb_cluster_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   12,
			NumExtensions: 0,
			NumServices:   1,
